 ...
 */
class ProviceBase extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('provice_name', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('provice_id, provice_name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('provice_name',$this->provice_name,true);
